    <!-- Cookie Alert Area-->
    <div class="cookiealert mb-0" role="alert" style="display: none;">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-12 col-sm-10 col-lg-3">
                    <div class="footer-widget-area mb-70">
                        <a class="d-block mb-4" href="index.html"><img src="<?php bloginfo('template_directory') ?>/img/core-img/domitos-white.png" alt=""></a>
                        <p>All in one operational suite for Facility Management.</p>
                        ...
                        <div class="footer-social-icon d-flex align-items-center"><a href="#" data-toggle="tooltip" data-placement="top" title="Facbook"><i class="fa fa-facebook"></i></a><a href="#" data-toggle="tooltip" data-placement="top" title="Twitter"><i class="fa fa-twitter"></i></a>
                            <a href="#" data-toggle="tooltip" data-placement="top" title="Instagram"><i class="fa fa-instagram"></i></a><a href="#" data-toggle="tooltip" data-placement="top" title="Linkedin"><i class="fa fa-linkedin"></i></a>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6 col-lg-5">
                    ...
                    <div class="footer--content-text">
                        <p class="mb-0">All rights reserved by <a href="#" target="_blank">mDrift Technologies</a></p>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-5">
                    <!-- Footer Nav-->
